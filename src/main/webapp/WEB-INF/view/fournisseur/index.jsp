    ...
    <tiles:putAttribute name="body">
        ...
        <div class="row">
            <div class="col-md-9">
                ...
                <div>
                    <h4>
                        ...
                        <spring:message code="fournisseur.liste" />
                    </h4>
                    <hr/>
                </div>
                ...
                <table class="table table-condensed table-hover table-bordered">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <spring:url value="/fournisseur/new" htmlEscape="true" var="fournisseur_new" />
                            <a href="${fournisseur_new}" class="btn btn-primary btn-sm">
                    ...
                    <c:forEach items="${fournisseurs}" var="fournisseur">
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <a href="${fournisseur_edit}" class="btn btn-primary btn-sm">
            ...
            <div class="col-md-3">
                ...
                <form:form method="get" commandName="jobSeeker" action="${fournisseur_home}">
                    ...
                    <button class="btn btn-default btn-sm">
                        ...
                        <spring:url value="/fournisseur/?size=${size}" htmlEscape="true" var="fournisseur_home" />
