    ...
    <tiles:putAttribute name="body">
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <h4>
                    ...
                    <spring:message code="fournisseur.modifier" />
                    : ${fournisseur.nom}
                </h4>
                <hr/>
            </div>
        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                <spring:url value="/fournisseur/${fournisseur.id}/update" var="fournisseur_update" htmlEscape="true"/>
                <form:form method="post" commandName="fournisseur" action="${fournisseur_update}">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-footer">
                            ...
                            <spring:url value="/fournisseur/" htmlEscape="true"
                                        var="fournisseur_home" />
