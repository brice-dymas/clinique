...
<tiles:insertDefinition name="layout">
    <tiles:putAttribute name="body">
        <div class="row">
            <div class="col-md-12">
                <h4>
                    <spring:message code="malade.modifier" />
                </h4>
                <hr/>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12 col-md-offset-0">
                <spring:url value="/dossiers/${malade.id}/update" var="malade_update"
                            htmlEscape="true" />
                <form:form method="post" commandName="malade" action="${malade_update}">
