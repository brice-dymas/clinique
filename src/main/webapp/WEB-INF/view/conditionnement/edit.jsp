    ...
    <tiles:putAttribute name="body">
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <h4>
                    ...
                    <spring:message code="conditionnement.modifier" />
                    : ${conditionnement.nom}
                </h4>
                <hr/>
            </div>
        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                <spring:url value="/conditionnement/${conditionnement.id}/update" var="conditionnement_update" htmlEscape="true"/>
                <form:form method="post" commandName="conditionnement" action="${conditionnement_update}">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-footer">
                            ...
                            <spring:url value="/conditionnement/" htmlEscape="true"
                                        var="conditionnement_home" />
