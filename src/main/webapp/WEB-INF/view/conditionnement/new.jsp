    ...
    <tiles:putAttribute name="body">
        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <h4>
                    ...
                    <spring:message code="conditionnement.nouveau" />
                </h4>
                <hr/>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                <spring:url value="/conditionnement/create" var="conditionnement_create"
                            htmlEscape="true" />
                <form:form method="post" commandName="conditionnement" action="${conditionnement_create}">
