    ...
    <tiles:putAttribute name="body">
        ...
        <div class="row">
                ...
                <table class="table table-condensed table-hover table-bordered">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <a href="${client_new}" class="btn btn-primary btn-sm">
                    ...
                    <c:forEach items="${clients}" var="client">
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <a href="${client_edit}" class="btn btn-primary btn-sm">
            ...
            <div class="col-md-3">
                ...
                <form:form method="get" commandName="jobSeeker" action="${client_home}">
                    ...
                    <button class="btn btn-default btn-sm">
                        ...
                        <spring:url value="/client/?size=${size}" htmlEscape="true" var="client_home" />
