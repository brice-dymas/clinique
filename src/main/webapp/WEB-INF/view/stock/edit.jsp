<%--
    Document   : new
    Created on : Sep 28, 2015, 9:20:13 AM
    Author     : sando
--%>
    ...
    <tiles:putAttribute name="body">
        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <h4>
                    ...
                    <spring:message code="stock.modifier" /> ${stock.produit.nom}
                </h4>
                <hr/>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-9 col-md-offset-3">
                <spring:url value="/stock/${stock.id}/${stock.produit.id}/update" var="stock_update"
                            htmlEscape="true" />
                <form:form method="post" commandName="stock" action="${stock_update}">
